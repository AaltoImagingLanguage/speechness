...
do
  ...
  echo "sed -e 's/1,100/$st_idx,$end_idx/g' -e 's/model_aw/model_$id/g' -e 's/_20150417/$data_ver/g' -e 's/tau_index=0/tau_index=$lag_number/g' mainNSF.m >mainNSF_$st_idx.m" >> Create_Scripts.sh  
